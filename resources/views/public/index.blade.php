        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 text-center">
                    <img loading="lazy" class="img-fluid" src="/assets/images/services/service-center.jpg"
                        ...
                        <div class="col-lg-4 col-sm-6 shuffle-item"
                            ...
                            <div class="project-img-container">
                                <a class="gallery-popup" href="/assets/images/projects/project1.jpg"
                                    ...
                                    <img class="img-fluid" src="/assets/images/projects/project1.jpg"
                                        alt="project-img">
                        ...
                        <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;healthcare&quot;]">
                            <div class="project-img-container">
                                <a class="gallery-popup" href="/assets/images/projects/project2.jpg"
                                    aria-label="project-img">
                                    <img class="img-fluid" src="/assets/images/projects/project2.jpg"
                                        alt="project-img">
                                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                </a>
                                <div class="project-item-info">
                        ...
                        <div class="col-lg-4 col-sm-6 shuffle-item"
                            ...
                            <div class="project-img-container">
                                <a class="gallery-popup" href="/assets/images/projects/project3.jpg"
                                    aria-label="project-img">
                                    <img class="img-fluid" src="/assets/images/projects/project3.jpg"
                                        alt="project-img">
                                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                </a>
                                <div class="project-item-info">
                        ...
                        <div class="col-lg-4 col-sm-6 shuffle-item"
                            ...
                            <div class="project-img-container">
                                <a class="gallery-popup" href="/assets/images/projects/project4.jpg"
                                    aria-label="project-img">
                                    <img class="img-fluid" src="/assets/images/projects/project4.jpg"
                                        alt="project-img">
                                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                </a>
                                <div class="project-item-info">
                        ...
                        <div class="col-lg-4 col-sm-6 shuffle-item"
                            ...
                            <div class="project-img-container">
                                <a class="gallery-popup" href="/assets/images/projects/project5.jpg"
                                    aria-label="project-img">
                                    <img class="img-fluid" src="/assets/images/projects/project5.jpg"
                                        alt="project-img">
                                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                </a>
                                <div class="project-item-info">
                        ...
                        <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;residential&quot;]">
                            <div class="project-img-container">
                                <a class="gallery-popup" href="/assets/images/projects/project6.jpg"
                                    aria-label="project-img">
                                    <img class="img-fluid" src="/assets/images/projects/project6.jpg"
                                        alt="project-img">
                                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                </a>
                                <div class="project-item-info">
                    ...
                    <div id="testimonial-slide" class="testimonial-slide">
                        ...
                        <div class="item">
                            <div class="quote-item">
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb"
                                        src="/assets/images/clients/testimonial2.png" alt="testimonial">
                                    <div class="quote-item-info">
                        ...
                        <div class="item">
                            <div class="quote-item">
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb"
                                        src="/assets/images/clients/testimonial3.png" alt="testimonial">
                                    <div class="quote-item-info">
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    ...
                    <div class="row all-clients">
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid"
                                        src="/assets/images/clients/client1.png" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 1 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid"
                                        src="/assets/images/clients/client2.png" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 2 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid"
                                        src="/assets/images/clients/client3.png" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 3 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid"
                                        src="/assets/images/clients/client4.png" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 4 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid"
                                        src="/assets/images/clients/client5.png" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 5 end -->
                        ...
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid"
                                        src="/assets/images/clients/client6.png" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 6 end -->
