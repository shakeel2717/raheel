                                    ...
                                    <div class="">
                                        <div class="ts-service-info">
                                            <h3 class="service-box-title"><a
                                                    href="{{ route('counter.edit', ['counter' => $counter->id]) }}">{{ $counter->name }}</a>
                                            </h3>
                                            <h3 class="service-box-title">Department: {{ $counter->department->name }}</h3>
                                            <p>{{ $counter->description }}</p>
                                            <a class="learn-more d-inline-block"
                                                href="{{ route('counter.edit', ['counter' => $counter->id]) }}"
