            ...
            <div class="row">
                <div class="col-12">
                    <div class="ts-intro">
                        ...
                        <h3 class="into-sub-title">Genearte Token</h3>
                        <br>
                                    ...
                                    <div class="">
                                        <div class="ts-service-info">
                                            ...
                                            <a class="learn-more d-inline-block"
                                                href="{{ route('token.generate', ['department' => $department->id]) }}"
                                                aria-label="service-details"><i class="fa fa-caret-right"></i> Generate
                                                Token</a>
                                        </div>
                                    </div>
                                </div>
